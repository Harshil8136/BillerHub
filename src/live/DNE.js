...
const DNE_NOTES = {
  all: {
    ...
    content: `
      ...
      <h4><i class="fa-solid fa-phone"></i> IVR Numbers (hover for details)</h4>
      <ul>
        <li><span class="copyable-phone" data-tooltip="DNE - VA Electric, North Carolina (Gas/Electric)">866-366-4357</span></li>
        <li><span class="copyable-phone" data-tooltip="Dominion Gas Ohio">833-261-1469</span></li>
        <li><span class="copyable-phone" data-tooltip="DNE-MRP">833-268-4343</span></li>
      </ul>

      <h4><i class="fa-solid fa-user-shield"></i> Internal Transfers</h4>
      <p class="contact-note-danger"><strong>These are internal numbers and are not to be shared with customers.</strong></p>
      <ul>
        <li><span class="color-danger">CSR Transfer (VA/NC): 888-429-0011</span></li>
        <li><span class="color-danger">CSR Transfer (OH): 866-313-8303</span></li>
        <li><span class="color-danger">CSR Transfer (WV): 866-313-8305</span></li>
      </ul>
