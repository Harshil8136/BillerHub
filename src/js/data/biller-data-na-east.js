...
},
{
  "id": 47,
  "live": false,
  "name": "Durham NC - MAIN (Utility Bill)",
  "tla": "DHNC",
  "aliases": ["City of Durham"],
  "paymentTypes": ["Utility Bill"],
  "kbLink": "https://kb.paymentus.io/display/CSR/DHNC+-+Durham%2C+NC",
  "adLink": "https://adg-ipn1.paymentus.net/dhnc?v2=true&lang=en",
  "contacts": [
    { "type": "IVR", "label": "IVR", "value": "844-592-4918" },
    { "type": "CSR", "label": "Customer Service", "value": "919-560-1200" }
  ],
  "timezone": "America/New_York",
  "notes": "Account format ######-###### (13 characters including dash). Primary utilities TLA; see DHNC notes for multi-service overview.",
  "areas": ["919","984"],
  "customFields": [
...
},
{
  "id": 48,
  "live": false,
  "name": "Durham NC (Miscellaneous Payment)",
  "tla": "DHNM",
  "aliases": ["City of Durham"],
  "paymentTypes": ["Miscellaneous Payment"],
  "kbLink": "https://kb.paymentus.io/display/CSR/DHNC+-+Durham%2C+NC",
  "adLink": "https://adg-ipn1.paymentus.net/dhnm?v2=true&lang=en",
  "contacts": [
    { "type": "IVR", "label": "IVR", "value": "844-592-4920" },
    { "type": "CSR", "label": "Customer Service", "value": "919-560-1200" }
  ],
  "timezone": "America/New_York",
  "notes": "Online: CP/OTP/ROTP/Autopay/IVR; card ~3.30% surcharge, bank $0.50 flat; see DHNC notes for full matrix.",
  "areas": ["919","984"],
  "customFields": [
    { "label": "Biller Website", "value": "https://durhamnc.gov/" }
  ]
},
{
  "id": 49,
  "live": false,
  "name": "Durham NC (City Services)",
  "tla": "DHCC",
  "aliases": ["City of Durham"],
  "paymentTypes": ["Cross Connections (City Services)"],
  "kbLink": "https://kb.paymentus.io/display/CSR/DHNC+-+Durham%2C+NC",
  "adLink": "https://adg-ipn1.paymentus.net/dhcc?v2=true&lang=en",
  "contacts": [
    { "type": "IVR", "label": "IVR", "value": "844-592-4920" },
    { "type": "CSR", "label": "Customer Service", "value": "919-560-1200" }
  ],
  "timezone": "America/New_York",
  "notes": "Online channels with card surcharge and bank flat fee; see DHNC notes.",
  "areas": ["919","984"],
  "customFields": [
    { "label": "Biller Website", "value": "https://durhamnc.gov/" }
  ]
},
{
  "id": 50,
  "live": false,
  "name": "Durham NC (Development Services)",
  "tla": "DHDS",
  "aliases": ["City of Durham"],
  "paymentTypes": ["Development Services"],
  "kbLink": "https://kb.paymentus.io/display/CSR/DHNC+-+Durham%2C+NC",
  "adLink": "https://adg-ipn1.paymentus.net/dhds?v2=true&lang=en",
  "contacts": [
    { "type": "IVR", "label": "IVR", "value": "844-592-4920" },
    { "type": "CSR", "label": "Customer Service", "value": "919-560-1200" }
  ],
...
},
{
  "id": 51,
  "live": false,
  "name": "Durham NC (Building Permit)",
  "tla": "DHBP",
  "aliases": ["City of Durham"],
  "paymentTypes": ["Building Permit"],
  "kbLink": "https://kb.paymentus.io/display/CSR/DHNC+-+Durham%2C+NC",
  "adLink": "https://adg-ipn1.paymentus.net/dhbp?v2=true&lang=en",
  "contacts": [
    { "type": "IVR", "label": "IVR", "value": "844-592-4920" },
    { "type": "CSR", "label": "Customer Service", "value": "919-560-1200" }
  ],
...
},
{
  "id": 52,
  "live": false,
  "name": "Durham NC (Fire Flow)",
  "tla": "DHNS",
  "aliases": ["City of Durham"],
  "paymentTypes": ["Fire Flow"],
  "kbLink": "https://kb.paymentus.io/display/CSR/DHNC+-+Durham%2C+NC",
  "adLink": "https://adg-ipn1.paymentus.net/dhns?v2=true&lang=en",
  "contacts": [
    { "type": "IVR", "label": "IVR", "value": "No IVR" },
    { "type": "CSR", "label": "Customer Service", "value": "919-560-1200" }
  ],
  "timezone": "America/New_York",
  "notes": "ROTP only; card surcharge and bank flat fee online; see DHNC notes.",
  "areas": ["919","984"],
  "customFields": [
    { "label": "Biller Website", "value": "https://durhamnc.gov/" }
  ]
},
{
  "id": 53,
  "live": false,
  "name": "Durham NC (Building Inspections)",
  "tla": "DHNB",
  "aliases": ["City of Durham"],
  "paymentTypes": ["Building Inspections"],
  "kbLink": "https://kb.paymentus.io/display/CSR/DHNC+-+Durham%2C+NC",
  "adLink": "https://adg-ipn1.paymentus.net/dhnb?v2=true&lang=en",
  "contacts": [
    { "type": "IVR", "label": "IVR", "value": "No IVR" },
    { "type": "CSR", "label": "Customer Service", "value": "919-560-1200" }
  ],
  "timezone": "America/New_York",
  "notes": "Online channels only; card surcharge and bank flat fee; see DHNC notes.",
  "areas": ["919","984"],
  "customFields": [
    { "label": "Biller Website", "value": "https://durhamnc.gov/" }
  ]
},
{
  "id": 54,
  "live": false,
  "name": "Durham NC (Government)",
  "tla": "DUCT",
  "aliases": ["Durham County Utility"],
  "paymentTypes": ["Government"],
  "kbLink": "https://kb.paymentus.io/display/CSR/DHNC+-+Durham%2C+NC",
  "adLink": "https://adg-ipn1.paymentus.net/duct?v2=true&lang=en",
  "contacts": [
    { "type": "IVR", "label": "IVR", "value": "No IVR" },
    { "type": "CSR", "label": "Customer Service", "value": "919-560-0430" }
  ],
  "timezone": "America/New_York",
  "notes": "Government payments; see DHNC notes for Durham-wide multi-service overview.",
  "areas": ["919","984"],
  "customFields": [
    { "label": "Biller Website", "value": "https://durhamnc.gov/" }
  ]
