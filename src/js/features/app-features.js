...
const Features = {
  ...
  Favorites: {
    ...
    _updateSidebarVisibility() {
      ...
      const hasFavorites = this.list.length > 0;
    ...
    toggle(billerId) {
      ...
      // Update the star on the main biller card if it's the one being toggled
      ...
      // Update the sidebar's visibility and content
      this._updateSidebarVisibility();

      // If the settings popover is open, re-render its favorites list too
