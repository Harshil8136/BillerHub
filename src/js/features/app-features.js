...
const Features = {
  ...
  Favorites: {
    list: [],
    init() { this.list = Utils.storageGet('biller-favorites', []); },
    toggle(billerId) {
  ...
  Settings: {
    init() {
      const settings = {
        ...
        showGreetingInHeader: Utils.storageGet('biller-setting-showGreeting', false),
      };
    ...
    handleToggle(e) {
      ...
      switch (id) {
        ...
        case 'toggleDebugLog':
            ...
            break;
        case 'toggleHeaderGreeting':
            settingKey = 'biller-setting-showGreeting';
            state.settings.showGreetingInHeader = checked;
            break;
      }
