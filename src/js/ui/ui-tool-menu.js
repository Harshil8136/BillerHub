...
UI.ToolMenu = {
  ...
  open() {
    ...
    // Defer positioning until the next animation frame to ensure correct dimensions
    requestAnimationFrame(() => {
      Positioning.adjust(this.triggerElement, this.menuElement);
    });
  ...
  _handleItemClick(item) {
      ...
      // Only handle non-link items, as links have default behavior
