 ...
 * UI FEE TOOL
 * ==================
 * UPDATED: Added the new "Copy for DCS Search" (Magic Fill) button
 * to the Investigation Notes panel.
 *
    ...
    const notesPaneHtml = `
        <div class="fee-tool-pane">
            ...
            <form class="investigation-notes-form">
                ...
                <hr class="notes-separator" />
                <div class="notes-dcs-section">
                    <div class="notes-dcs-header">DCS Auto-Fill (Magic Fill)</div>
                    <button type="button" class="notes-dcs-copy">
                        <i class="fa-solid fa-wand-magic-sparkles"></i> Copy for DCS Search
                    </button>
                </div>
            </form>
        </div>
